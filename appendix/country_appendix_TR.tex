\section{Turkey\label{app:TR}}

% \subsection{Knowledge about climate change}

% In France most people believe that climate change is anthropogenic. 57\% of them believe that human activity causes ``a lot'' or ``most'' of climate change (see Panel A Figure \ref{fig:app_TR_knowledge_desc}). Yet, France falls below the 70\% average in high-income countries along this dimension (see Figure \ref{fig:knowledge_positive}). Furthermore, around one half of respondents believe that cutting GHG emissions by half would be sufficient to stop the rise in temperatures (see Panel B Figure \ref{fig:app_TR_knowledge_desc}). 
...
% Regarding \textit{per capita} footprint only a minority knows the full correct ranking (see Panel C Figure \ref{fig:app_TR_knowledge_desc}). Respondents understand that sea-level rises and severe droughts and heatwaves are more likely if nothing is done to limit climate change, but at the same time only 37\% know that it is unlikely that it will lead to more frequent volcanic eruptions (see Panel D Figure \ref{fig:app_TR_knowledge_desc}).

% As shown in Figure \ref{fig:app_TR_knowledge_setA}, there are some differences across respondents regarding their knowledge about climate change. Most notably, people with a college degree and left-leaning or center voters are more accurate than right-leaning voters and very left-leaning ones. 
...
\begin{figure}[h!]
    \caption{Knowledge about climate change}\label{fig:app_TR_knowledge_desc}
    \begin{center}
        \begin{tabular}{cc}
            ...
            \textsc{do you think is due to human activity?''} & \textsc{cutting global GHG emissions by half} \\
             & \textsc{would be sufficient to eventually}\\
			  ...
			  \includegraphics[width=2.5in]{figures/appendix/TR/CC_anthropogenic.pdf} & \includegraphics[width=2.5in]{figures/appendix/TR/CC_dynamic.pdf}
			  %\includegraphics[width=2.5in]{figures/appendix/TR/Appendix_Fig1A_TR.pdf} & \includegraphics[width=2.5in]{figures/appendix/TR/Appendix_Fig1B_TR.pdf}
        \end{tabular}
        \begin{tabular}{c}
            \textsc{Panel C: GHG Emission Ranking} \\
            %\includegraphics[width=6in]{figures/appendix/TR/Appendix_Fig1C_TR.pdf} 
			\includegraphics[width=6in]{figures/appendix/TR/CC_impacts3.pdf} \\
            % \textsc{Panel D: Climate Change Gases} \\
            % \includegraphics[width=4.5in]{figures/appendix/TR/Appendix_Fig1D_TR.pdf} \\
            \\
            ...
            %\includegraphics[width=4in]{figures/appendix/TR/Appendix_Fig1E_TR.pdf}
			\includegraphics[width=4in]{figures/appendix/TR/footprint2.pdf}
        \end{tabular}
    \end{center}
\end{figure}
...
\begin{figure}[h!]
    %\centering
    \caption{Who has better knowledge about climate change?}\label{fig:app_TR_knowledge_setA}
    %Knowledge of climate change regressed on individual characteristics.}
    \vspace{-.5em}
    \hspace{-5em}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth, right]{figures/appendix/TR/Coefplot_SetA_iknow_all_TR.pdf}} \label{fig:Coefplot_SetA_iknow_all_TR}
    \end{center}
\vspace{.1cm}
\par
...
\begin{figure}[h!]
    %\centering
    \caption{Share of respondents who support or oppose climate change policies.}\label{fig:app_TR_support_desc}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/TR/national_policies.pdf}} %\label{fig:national_policies}
    \end{center}
...
\begin{figure}[h!]
    ...
    Share of people's answers to the willingness to adopt different behaviors and to the importance of different conditions for such adoption.}\label{fig:app_TR_willingness_desc}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/TR/willingness_conditions_all.pdf}} % willing_positive_countries willing_all_positive_countries
    %\label{fig:willing}
...
\begin{figure}%[h!]
    %\centering
    \caption{Which respondents support climate action? \label{fig:app_TR_support_setAB}}
    \vspace{-.5em}
    \hspace{-5em}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/TR/Coefplot_SetAB_imainpols_all_TR.pdf}}     \label{fig:Coefplot_SetAB_imainpols_all_TR}
    \end{center}
...
\begin{figure}[h!]
    %\centering
    \caption{Properties of the main policies. [Share of agreement]\label{fig:app_TR_pol_prop}}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/TR/Heatplot_main_policies_all_win_positive_TR.pdf}} %\label{fig:Heatplot_main_policies_all_win_positive_countries}
    \end{center}
...
\begin{figure}[h!]
    ...
    \label{fig:app_TR_support_setC}}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/TR/Coefplot_SetAC_PlotCdis_combined_pols_TR.pdf}} % Coefplot_SetAC_PlotC_index_main_policies_all
    \label{fig:Coefplot_SetAC_PlotCdis_combined_pols_TR}
    \end{center}
...
\begin{figure}[h!]
    ...
    \label{fig:app_TR_suppot_setAt}}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/TR/Coefplot_SetAT_PlotT_support_main_others_TR.pdf}} \label{fig:Coefplot_SetAT_PlotT_support_main_others_TR} 
    \end{center}
...
\begin{figure}[h!]
    %\centering
    \caption{Distributions of profiles by socio-demographic and energy usage characteristics \label{fig:app_TR_LDA_desc}}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/TR/topic_factor_subgroups_TR.pdf}} %\label{fig:lda}
