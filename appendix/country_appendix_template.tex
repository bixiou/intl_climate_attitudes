\section{[Country]\label{app:[country]}}

% \subsection{Knowledge about climate change}

% In France most people believe that climate change is anthropogenic. 57\% of them believe that human activity causes ``a lot'' or ``most'' of climate change (see Panel A Figure \ref{fig:app_[country]_knowledge_desc}). Yet, France falls below the 70\% average in high-income countries along this dimension (see Figure \ref{fig:knowledge_positive}). Furthermore, around one half of respondents believe that cutting GHG emissions by half would be sufficient to stop the rise in temperatures (see Panel B Figure \ref{fig:app_[country]_knowledge_desc}). 
...
% Regarding \textit{per capita} footprint only a minority knows the full correct ranking (see Panel C Figure \ref{fig:app_[country]_knowledge_desc}). Respondents understand that sea-level rises and severe droughts and heatwaves are more likely if nothing is done to limit climate change, but at the same time only 37\% know that it is unlikely that it will lead to more frequent volcanic eruptions (see Panel D Figure \ref{fig:app_[country]_knowledge_desc}).

% As shown in Figure \ref{fig:app_[country]_knowledge_setA}, there are some differences across respondents regarding their knowledge about climate change. Most notably, people with a college degree and left-leaning or center voters are more accurate than right-leaning voters and very left-leaning ones. 
...
\begin{figure}[h!]
    \caption{Knowledge about climate change}\label{fig:app_[country]_knowledge_desc}
    \begin{center}
        \begin{tabular}{cc}
            ...
            \textsc{do you think is due to human activity?''} & \textsc{cutting global GHG emissions by half} \\
             & \textsc{would be sufficient to eventually}\\
			  ...
			  \includegraphics[width=2.5in]{figures/appendix/[country]/CC_anthropogenic.pdf} & \includegraphics[width=2.5in]{figures/appendix/[country]/CC_dynamic.pdf}
			  %\includegraphics[width=2.5in]{figures/appendix/[country]/Appendix_Fig1A_[country].pdf} & \includegraphics[width=2.5in]{figures/appendix/[country]/Appendix_Fig1B_[country].pdf}
        \end{tabular}
        \begin{tabular}{c}
            \textsc{Panel C: GHG Emission Ranking} \\
            %\includegraphics[width=6in]{figures/appendix/[country]/Appendix_Fig1C_[country].pdf} 
			\includegraphics[width=6in]{figures/appendix/[country]/CC_impacts3.pdf} \\
            % \textsc{Panel D: Climate Change Gases} \\
            % \includegraphics[width=4.5in]{figures/appendix/[country]/Appendix_Fig1D_[country].pdf} \\
            \\
            ...
            %\includegraphics[width=4in]{figures/appendix/[country]/Appendix_Fig1E_[country].pdf}
			\includegraphics[width=4in]{figures/appendix/[country]/footprint2.pdf}
        \end{tabular}
    \end{center}
\end{figure}
...
\begin{figure}[h!]
    %\centering
    \caption{Who has better knowledge about climate change?}\label{fig:app_[country]_knowledge_setA}
    %Knowledge of climate change regressed on individual characteristics.}
    \vspace{-.5em}
    \hspace{-5em}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth, right]{figures/appendix/[country]/Coefplot_SetA_iknow_all_[country].pdf}} \label{fig:Coefplot_SetA_iknow_all_[country]}
    \end{center}
\vspace{.1cm}
\par
...
\begin{figure}[h!]
    %\centering
    \caption{Share of respondents who support or oppose climate change policies.}\label{fig:app_[country]_support_desc}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/[country]/national_policies.pdf}} %\label{fig:national_policies}
    \end{center}
...
\begin{figure}[h!]
    ...
    Share of people's answers to the willingness to adopt different behaviors and to the importance of different conditions for such adoption.}\label{fig:app_[country]_willingness_desc}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/[country]/willingness_conditions_all.pdf}} % willing_positive_countries willing_all_positive_countries
    %\label{fig:willing}
...
\begin{figure}%[h!]
    %\centering
    \caption{Which respondents support climate action? \label{fig:app_[country]_support_setAB}}
    \vspace{-.5em}
    \hspace{-5em}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/[country]/Coefplot_SetAB_imainpols_all_[country].pdf}}     \label{fig:Coefplot_SetAB_imainpols_all_[country]}
    \end{center}
...
\begin{figure}[h!]
    %\centering
    \caption{Properties of the main policies. [Share of agreement]\label{fig:app_[country]_pol_prop}}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/[country]/Heatplot_main_policies_all_win_positive_[country].pdf}} %\label{fig:Heatplot_main_policies_all_win_positive_countries}
    \end{center}
...
\begin{figure}[h!]
    ...
    \label{fig:app_[country]_support_setC}}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/[country]/Coefplot_SetAC_PlotCdis_combined_pols_[country].pdf}} % Coefplot_SetAC_PlotC_index_main_policies_all
    \label{fig:Coefplot_SetAC_PlotCdis_combined_pols_[country]}
    \end{center}
...
\begin{figure}[h!]
    ...
    \label{fig:app_[country]_suppot_setAt}}
    \begin{center}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/[country]/Coefplot_SetAT_PlotT_support_main_others_[country].pdf}} \label{fig:Coefplot_SetAT_PlotT_support_main_others_[country]} 
    \end{center}
...
\begin{figure}[h!]
    %\centering
    \caption{Distributions of profiles by socio-demographic and energy usage characteristics \label{fig:app_[country]_LDA_desc}}
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{figures/appendix/[country]/topic_factor_subgroups_[country].pdf}} %\label{fig:lda}
